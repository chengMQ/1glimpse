...
def list2html(table_html):
    ...
    head = "<div id='{}'><table style='table-layout:fixed;' cellspacing=2 cellpadding=3 width='100%' align='center'><tbody><p><h2 style='font-size:38px;' align='center'>{}&nbsp;[ {} 篇 ]&nbsp;&nbsp;&nbsp;<a href='#headline' style='font-size:28px;'>&circlearrowleft;</a></h2></p><hr>blablablabla</tbody></table></div>".format(
